...
} from "./src/features/dreams/DreamProgressSections";
import {
...
import {
  getAutoSavedMemoryNotice,
  getConfirmButtonLabel,
  getDreamSavePromptKind,
  getDuplicateMemoryNotice,
  getGoalTargetLabel,
  getPendingMemoryNotice,
  getSavedMemoryNotice,
  shouldHideSaveUi,
} from "./src/noie/saveDisplayLogic";
import {
...
import {
  ...
  repairRecentDreamFragmentLinks,
  repairRoutineTitlesFromOriginalText,
} from "./src/noie/dataMaintenanceLogic";
import {
  ...
  const loadSavedData = async () => {
    try {
      ...
      if (Array.isArray(parsedDailyLongRecords)) {
        setDailyLongRecords(normalizeDailyLongRecords(
          parsedDailyLongRecords,
